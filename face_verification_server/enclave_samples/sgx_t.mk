...
ifeq ($(SGX_DEBUG), 1)
        ...
        SGX_COMMON_CFLAGS += -O3 -flto -mavx -msse4 -maes -ftree-vectorize
endif
...
Samples_Cpp_Flags :=  $(Common_C_Cpp_Flags) -std=c++11 -nostdinc++ -fno-builtin-printf -fpermissive -I. $(EPCPP_CACHE_SIZE)
...
trusted/face_verification/%.o : trusted/face_verification/%.cpp
	@$(CXX) $(Samples_Cpp_Flags) -c $< -o $@
	@echo "CXX  <=  $<"
