...
App_Cpp_Files := $(UNTRUSTED_DIR)/sample.cpp $(UNTRUSTED_DIR)/memset.cpp # $(wildcard App/TrustedLibrary/*.cpp)
App_Include_Paths := -IInclude -I$(UNTRUSTED_DIR) -I$(SGX_SDK)/include -I$(unrusted_services_lib)/untrusted -I$(unrusted_services_lib)

App_C_Flags := $(SGX_COMMON_CFLAGS) -fPIC -Wno-attributes $(App_Include_Paths) $(EPCPP_CACHE_SIZE)
...
App_Link_Flags := $(SGX_COMMON_CFLAGS) -L$(SGX_LIBRARY_PATH) -l$(Urts_Library_Name) -L$(unrusted_services_lib) -l_services.untrusted -lpthread -lrt -ldl
