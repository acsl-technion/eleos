...
Samples_Cpp_Files := $(wildcard trusted/*.cpp)
Samples_C_Files := 
Samples_Include_Paths := -IInclude -Itrusted -I$(SGX_SDK)/include -I$(SGX_SDK)/include/tlibc -I$(SGX_SDK)/include/stlport -I$(services_lib)/static_trusted

Flags_Just_For_C := -Wno-implicit-function-declaration -std=c11 -DSQLITE_THREADSAFE=0 $(EPCPP_CACHE_SIZE) $(RANDOM_ACCESS)
...
Samples_Cpp_Flags :=  $(Common_C_Cpp_Flags) -std=c++11 -nostdinc++ -fno-builtin-printf -I.

Samples_Cpp_Flags := $(Samples_Cpp_Flags)  -fno-builtin-printf -fPIC $(EPCPP_CACHE_SIZE) $(RANDOM_ACCESS)
